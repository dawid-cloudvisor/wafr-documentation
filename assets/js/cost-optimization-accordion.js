console.log('Cost optimization accordion script loading...');

document.addEventListener('DOMContentLoaded', function() {
  console.log('Cost optimization accordion DOM loaded');
  ...
  console.log('Cost optimization accordion setup complete');
});
